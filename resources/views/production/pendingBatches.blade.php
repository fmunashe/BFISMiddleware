...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>  Pending Batch History Report</h3>
            <ol class="breadcrumb">
            ...
            <table class="table table-hover table-condensed table-striped jambo_table bulk_action">
                ...
                @foreach($batches as $batch)
                    <tr>
                        ...
                        <td><a data-toggle="tooltip" data-placement="left" title="Show Records" href="{{route('viewLocalRecords',['id'=>$batch->batch_split_id])}}"><span class="btn btn-sm btn-success fa fa-eye"></span></a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
